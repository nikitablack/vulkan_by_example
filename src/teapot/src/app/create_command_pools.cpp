...
MaybeAppData create_command_pools(AppData data)
{
	...
	helpers::MaybeCommandPool const mbDynamicCommandPool{helpers::create_command_pool(data.device, data.graphicsFamilyQueueIndex, VK_COMMAND_POOL_CREATE_TRANSIENT_BIT)};
